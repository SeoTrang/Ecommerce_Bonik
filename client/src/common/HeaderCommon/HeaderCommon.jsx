        ...
        <div className="container p-relative">
          <div className="row">
            <div className="col-xl-2 col-lg-2 col-md-3  col-6">
              <Link
                to={"/"}
                className="logo d-flex align-items-center shofy-h-66"
              >
                <img src={Logo2} alt="" />
              </Link>
            </div>
                ...
                <div className="p-0 form-search" >
                  <div className="d-flex align-items-center row ">
                    ...
                    <div className="icon-search col-3 text-center ">
                      <button onClick={handleSearch} className="123 border-0 btn-search w-100 ">
            ...
            <div className="col-xl-2 col-lg-2 col-md-2 col-6">
              <div className="user-action d-flex align-items-center justify-content-end shofy-h-66">
                <div
                  ...
                  className="btn-search-icon d-md-none d-lg-none d-xl-none"
                >
                  <i class="fa-solid fa-magnifying-glass"></i>
                </div>
