...
import { fetchWishlistData } from "../../redux/actions/wishlistAction";
...
const Header = () => {
  ...
  const [languegeState, setLanguageState] = useState("vi");
  const [currencyState, setCurrencyState] = useState("VNĐ");
  ...
  const handleSearch = () => {
    return navigate("/product?search="+searchText);
  }
  return (
    <>
      <div className={" header p-relative"}>
          ...
          <div className="container p-relative mt-2">
            <div className="row">
                        ...
                        <div className="row pe-5 ps-5">
                          <div className="category col-3">
                            ...
                            <div className="List-items">
                              <div className="item">
                                {" "}
                                {t("app.header._mobilePhone")}
                              </div>
                              <div className="item">
                                {t("app.header._laptop")}
                              </div>
                              <div className="item">
                                {t("app.header._tablet")}
                              </div>
                              <div className="item">
                                {t("app.header._earphone")}
                              </div>
                              <div className="item">
                                {t("app.header._smartwatch")}
                              </div>
                              <div className="item">
                                {t("app.header._watch")}
                              </div>
                          ...
                          <div className="category col-3">
                            ...
                            <div className="List-items">
                              <div className="item">
                                {t("app.header._powerBank")}
                              </div>
                              <div className="item">
                                {t("app.header._chargerCable")}
                              </div>
                              <div className="item">
                                {t("app.header._hubAdapter")}
                              </div>
                              <div className="item">
                                {t("app.header._phoneCase")}
                              </div>
                              <div className="item">
                                {t("app.header._tabletCase")}
                              </div>
                              <div className="item">
                                {t("app.header._screenProtector")}
                              </div>
                              <div className="item">
                                {t("app.header._airPodsCase")}
                              </div>
                              <div className="item">
                                {t("app.header._airTagAccessory")}
                              </div>
                              <div className="item">
                                {t("app.header._phoneStand")}
                              </div>
                            </div>
                          </div>
                          <div className="category col-3">
                            ...
                            <div className="List-items">
                              <div className="item">
                                {t("app.header._computerMouse")}
                              </div>
                              <div className="item">
                                {t("app.header._keyboard")}
                              </div>
                              <div className="item">
                                {t("app.header._networkDevice")}
                              </div>
                              <div className="item">
                                {t("app.header._backpack")}
                              </div>
                              <div className="item">
                                {t("app.header._laptopBag")}
                              </div>
                              <div className="item">
                                {t("app.header._laptopStand")}
                              </div>
                              <div className="item">
                                {t("app.header._software")}
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="category col-3">
                            ...
                            <div className="List-items">
                              <div className="item">
                                {t("app.header._bluetoothEarphones")}
                              </div>
                              <div className="item">
                                {t("app.header._wiredEarphones")}
                              </div>
                              <div className="item">
                                {t("app.header._speaker")}
                              </div>
                              <div className="item">
                                {t("app.header._microphone")}
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="col-6 col-xl-3 col-lg-3  ">
                ...
                <div className="languege-lg d-block d-lg-none">
                      <button
                      ...
                      >
                        <div className="d-flex languege-active">
                          <div className="img">
                            <img
                              src={languegeState == "en" ? usFlag : vnFlag}
                              alt=""
                            />
                          </div>
                          {/* <div className="text">
                        ...
                        >
                          <a class="dropdown-item" href="#">
                            <div className="d-flex">
                              ...
                              <div className="text">Việt Nam</div>
                            </div>
                          </a>
                        </li>
                        <li
                  ...
                  <div onClick={handleOpenMiniCart} className="cart ms-3">
              ...
              <div className="row  align-items-center">
                <div className="col-6 item-left">
                  <div className="content d-flex align-items-center">
                    ...
                    <div className="text ms-2">{t("app.header.wellcome")}</div>
                  </div>
                </div>
                <div className="col-6">
                    ...
                    <div className="setting ms-2    ">
                      <div className="icon">
                        <svg
                          ...
                          aria-hidden="true"
                          role="img"
                          class="component-iconify MuiBox-root css-9uy14h iconify iconify--solar"
                          width="1em"
                          height="1em"
                          viewBox="0 0 24 24"
                        >
                          <g fill="currentColor">
                            <path
                              ...
                              opacity=".5"
                            ></path>
                            <path d="M15.523 12c0 1.657-1.354 3-3.023 3c-1.67 0-3.023-1.343-3.023-3S10.83 9 12.5 9c1.67 0 3.023 1.343 3.023 3Z"></path>
                          </g>
                        </svg>
                      </div>
                    </div>
                  ...
                  <form className="p-0" action="">
                    <div className="d-flex align-items-center row shofy-h-50">
                      <div className=" col-10 border-box container">
                        <input
                          className=" border-0 outline-0 w-100 ms-3"
                          type="text"
                          onChange={(e)=>{setSearchText(e.target.value)}}
                          placeholder={t("app.header.Search for products...")}
                        />
                      </div>
                      <div className="icon-search col-2 text-center shofy-h-50">
                        <button onClick={handleSearch} className="border-0 btn-search w-100 shofy-h-50">
                          <i class="fa-solid fa-magnifying-glass"></i>
                        </button>
                      </div>
                    </div>
              ...
              <div className="col-xl-3 col-lg-4 col-md-8 col-6 user align-items-center shofy-h-50">
                <div className="header-right d-flex align-items-center justify-content-end shofy-h-50">
                  {user ? (
                    <Link
                      to={"/profile/Home"}
                      className="header-profile d-flex align-items-center d-none d-lg-block"
                    >
                    ...
                    <Link
                      to={"/login"}
                      className="header-profile align-items-center d-none d-lg-block "
                    >
                      <div className="shofy-user d-flex">
                  ...
                  <div className="user-action hello d-flex align-items-center">
                    <div className="languege-lg d-block d-lg-none">
                      <button
                        class="btn dropdown-toggle"
                        data-bs-toggle="dropdown"
                    ...
                    <Link
                      to={"/wishlist"}
                      className="Wishlist ms-3 d-none d-md-block"
                    >
                      <div className="p-1">
                        <svg
                          _ngcontent-ng-c3631614527=""
        ...
        <div
          className={
            styles.headerBottom +
            " shofy-header-bottom shofy-h-50 mt-3 d-none d-lg-block d-xl-block"
          }
        >
          <div className="container shofy-h-50">
            <div className="row p-relative shofy-h-50">
              <div className="col-3 items-1 dropdown shofy-h-50">
                <button
                  className="shofy-h-50 ps-3 pe-3 w-100 border-0 d-flex align-items-center justify-content-between dropdown-toggle"
                  type="button"
                  data-bs-toggle="dropdown"
                  aria-expanded="true"
                >
                ...
                <ul class="dropdown-menu dropdown-menu-light menu-dropdown">
                  <li>
                    <a
                      class="dropdown-item d-flex justify-content-between ps-4 pe-4 mt-2 align-items-center"
                      href="#"
                    >
                      <div className="left">
                        <img
                    ...
                    <ul class="list-group list-group-menu list-group-flush">
                      <li class="list-group-item ">
                        {t("app.header.Kids Headphones")}
                      </li>
                      <li class="list-group-item">
                        {t("app.header.Bluetooth Headphones")}
                      </li>
                      <li class="list-group-item">
                        {t("app.header.On-Ear Headphones")}
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    >
                      <div className="left">
                        <img
                          src="https://i.ibb.co/xHFpQTV/product-cat-2.png"
                          alt=""
                        />
                  ...
                  <li>
                    ...
                    >
                      <div className="left">
                        <img
                          src="https://i.ibb.co/S0GjZdp/product-cat-3.png"
                          alt=""
                        />
                  ...
                  <li>
                    ...
                    >
                      <div className="left">
                        <img
                          src="https://i.ibb.co/g3YK8H2/product-cat-4.png"
                          alt=""
                        />
                  ...
                  <li>
                    ...
                    >
                      <div className="left">
                        <img
                          src="https://i.ibb.co/D9qfYWX/product-cat-5.png"
                          alt=""
                        />
                      ...
                      <div className="row pe-5 ps-5">
                        <div className="category col-3">
                          ...
                          <div className="List-items">
                            ...
                            <div className="item">{t("app.header._watch")}</div>
                            <div className="item">{t("app.header._tivi")}</div>
                          </div>
                        </div>
                        <div className="category col-3">
                          <div className="title mt-2">
              ...
              <div className="col-2 shofy-h-50 shofy-hotline">
                <div className="d-flex align-items-center">
                  ...
                  <div className="hotline">
                    ...
                    <div className="value">+(84) 386 643 97</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {showInputSearch == true && (
          <div onClick={handleHiddenInputSearch} className="input-search-1">
